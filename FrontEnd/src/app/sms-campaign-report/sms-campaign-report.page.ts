...
@Component({
  selector: 'app-sms-campaign-report',
  templateUrl: './sms-campaign-report.page.html',
  styleUrls: ['./sms-campaign-report.page.scss'],
})
export class SmsCampaignReportPage implements OnInit {
  ...
  pdf() {
    var element = document.getElementById('campaignReport');
