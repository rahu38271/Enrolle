...
omit_special_char(event) {
  ...
  constructor(
    ...
    this.enquiryModal = this.router.getCurrentNavigation().extras.state;
  }
  ...
  editEnquiry(){
    ...
    if(this.enquiryModal.birthDate == ""){
      this.enquiryModal.birthDate = null
    }
    
    if(this.enquiryModal.anniversary == ""){
      this.enquiryModal.anniversary = null
    }
    ...
    this.enquiry.addSingleEnquiry(this.enquiryModal).subscribe(data=>{
      if(data){
        this.loader.hideLoader();
        this.enquiryModal = {};
        this.toast.presentToast("Enquiry updated successfully!", "success", 'checkmark-circle-sharp');
        this.router.navigate(['/general-enquiry']);
      }
      else{
        this.loader.hideLoader();
        this.toast.presentToast("Enquiry not updated", "danger", 'alert-circle-sharp');
      }
    },(err)=>{
      this.loader.hideLoader();
      this.toast.presentToast("Enquiry not updated", "danger", 'alert-circle-sharp');
