...
@Component({
  selector: 'app-view-mobile-group',
  templateUrl: './view-mobile-group.component.html',
  styleUrls: ['./view-mobile-group.component.scss'],
})
export class ViewMobileGroupComponent implements OnInit {
  ...
  pdf() {
    var element = document.getElementById('table40');
