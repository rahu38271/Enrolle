...
export class SettingService {
  ...
  getBirthdaySMS(){
    ...
    return this.http.get<any>(this.url+'SmsSetting/GetLastSmsSettingbyType?MType=Birthday',{ headers })
  }
  ...
  getAnniversarySMS(){
    ...
    return this.http.get<any>(this.url+'SmsSetting/GetLastSmsSettingbyType?MType=Anniversary',{ headers })
  }
