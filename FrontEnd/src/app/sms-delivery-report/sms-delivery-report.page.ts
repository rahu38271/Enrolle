...
@Component({
  selector: 'app-sms-delivery-report',
  templateUrl: './sms-delivery-report.page.html',
  styleUrls: ['./sms-delivery-report.page.scss'],
})
export class SmsDeliveryReportPage implements OnInit {
