...
import { PoliticalPartyReportPageRoutingModule } from './political-party-report-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    PoliticalPartyReportPageRoutingModule,
    ChartModule,
...
export class PoliticalPartyReportPageModule {}
